...
%foldR(F, 0, [2,3]) -> F(2, foldR(F, 0, [3]))  -> F(2, F(3, foldR(F, 0, []))) -> 
% F(2, F(3, 0)) ->

% foldL(F, 0, [2,3]) -> foldL(F, F(2,0), [3]) -> foldL(F, F(3, F(2,0)), []) -> F(3, F(2,0)) -> 3 - F(2,0) -> 3 - 2 - 0 

% foldR(F, 0, [2,3]) -> foldR(F, F(0,2), [3] -> foldR(F, F(F(0,2), 3), []) -> 
